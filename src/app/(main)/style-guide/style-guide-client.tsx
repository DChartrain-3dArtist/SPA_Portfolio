// Ce fichier a été renommé de page.tsx à style-guide-client.tsx
// pour séparer la logique client de l'export des métadonnées.
'use client';
 ...
 * @param {string} [props.description] - La description optionnelle de la section.
 * @param {React.ReactNode} props.children - Le contenu de la section.
 * @returns Un composant React pour une section.
 */
 ...
 * @param {object} props - Les propriétés du composant.
 * @param {Array<{name: string, hsl: string, hex: string}>} props.colors - Le tableau des couleurs à afficher.
 * @returns Un composant React affichant une grille de couleurs.
 */
...
/**
 * Composant pour afficher un échantillon de typographie.
 * @param {object} props - Les propriétés du composant.
 * @returns Un composant React pour un échantillon de texte.
 */
...
/**
 * Composant client pour la page de la charte graphique.
 * Contient toute la logique interactive et l'affichage des éléments.
 * @returns Un composant React pour la page de la charte graphique.
 */
export default function StyleGuideClientPage() {
